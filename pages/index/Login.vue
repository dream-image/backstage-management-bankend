<template>
  <div>
    <NuxtErrorBoundary @error="refreshAll">
      <ClientOnly>
      ...
      url="http://foo.bar/particles.json" /> -->
          ...
          <vue-particles id="tsparticles" :particlesInit="particlesInit" :particlesLoaded="particlesLoaded"
            :options="options" v-if="showParticles" />
        </div>
        <div id="a">
          <div id="login_box">
        ...
        ">
                  <div>
                    <el-input v-model="username" placeholder="用户名" clearable
                      style="width: 200px;transform: translateY(-4px);" round>
                      <template #prefix>
                  ...
                  <div>
                    <el-input v-model="password" placeholder="密码" clearable
                      style="width: 200px;transform: translateY(5px);" show-password>
                      <template #prefix>
                        <el-icon class="el-input__icon" color="#108b96">
                          <Lock />
                        </el-icon>
                  ...
                  <div>
                    <el-button type="primary" style="width: 200px;transform: translateY(-7px);"
...
<script setup>
const hasRefresh = customRef((track, trigger) => {
  return {
    get() {
      track()
      return eval(localStorage.getItem('hasRefresh')) ?? false
    },
    set(newValue) {
      trigger()
      localStorage.setItem('hasRefresh', newValue)
    }
  }
